...
<body onLoad="checkResult();document.getElementById('idSrchAuditTable').focus()" >
	...
	<form name="searchLookUpForm" onSubmit="fnReloadLookup();return false;">
		&nbsp;&nbsp;AuditTable: &nbsp;&nbsp;<input type="text" disabled="disabled" id="idSrchAuditTable"
			name="srchBatchId" value="${htmlElementValue}"> &nbsp;&nbsp;
	</form>
	<br>
