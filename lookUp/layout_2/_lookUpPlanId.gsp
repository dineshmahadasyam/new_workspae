...
<body onLoad="checkResult()" >
	...
	<form name="searchLookUpForm" onSubmit="fnReloadLookup();return false;">
		&nbsp;&nbsp;Group ID: &nbsp;&nbsp;<input type="text" id="groupId"
			name="groupId" value="${htmlElementValue}" readonly="readonly"> &nbsp;&nbsp;<input
			class="search" type="button" name="Search" value="Search"
			onclick="fnReloadLookup()">
	</form>
	<br>
	<form name="lookUpMainForm">
	<input type="hidden" id="seq_prem_id" value=""/>
				...
				<tbody>
					...
					%>
						...
						<%String searchKeyMethodName = cdoClassAttributeName							
							 ...
							 %>
							<td nowrap="nowrap"><input type="radio" name="myLookUpValue" value="${searchKeyGetMeth.invoke(cdoObject) }" onclick="populateSeqPremId(${ searchKeyGetMeth2.invoke(cdoObject) })"/>&nbsp;&nbsp;${ searchKeyGetMeth.invoke(cdoObject) }
