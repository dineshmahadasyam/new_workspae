				...
				<div class="fms_widget form-inline" style="padding-bottom:0;">
		 			<form name="searchLookUpForm" onSubmit="fnReloadLookup();return false;">
						...
						<div id="lookupSpinner" style="display:none">
       					...
       					<input id="processId" value="${htmlElementValue}" type="text" class="form-control" name="htmlElementValue" aria-labelledby="SearchAgain_label" aria-required="false" autofocus>
       					<button class="btn btn-primary btn-sm" onclick="fnReloadLookup();document.getElementById('lookupSpinner').style.display='block';"><i class="glyphicon glyphicon-search"></i> Search Again</button>      
      				</form>          
     			</div>
