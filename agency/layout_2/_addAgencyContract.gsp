...
<body>
	...
	<div id="show-agency" class="content scaffold-show" role="main">
		<h1 style="color: #48802C">Add Contract to Agency : ${agencyInstance?.agencyId }</h1>
			...
			<tr>
				<td>
					<table class="report" border="0" style="table-layout: fixed;" id="report">
						<tr>
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agencyGroupContract, field: 'groupId', 'error')} ">
									<label for="groupId"> 
										<g:message code="agencyGroupContract.groupId.label" default="Group ID :" />
											<span class="required-indicator">*</span>
									</label>
									
									<input type="hidden" id="agencyGroupContract.0.seqGroupId" name="agencyGroupContract.0.seqGroupId" value="${agencyGroupContract?.seqGroupId}"/>														
									<g:textField name="groupId" id="groupId" value="${params.groupId }" title="The Group ID" onblur = "populateDescription()" onchange="upperMe();populateDescription()"/>
									<img width="25" height="25" style="float:none;vertical-align:bottom" class="magnifying"
										...
										onclick="lookup('groupId', 'com.perotsystems.diamond.dao.cdo.GroupMaster','groupId',null, null, 'agencyGroupContract.0.seqGroupId', 'seqGroupId' )">
								</div>
						...
						<tr>
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agencyGroupContract, field: 'planRiderCode', 'error')} ">
									<label for="planRiderCode"> 
										<g:message code="agencyGroupContract.planRiderCode.label" default="Plan/Rider Code :" />
										<span class="required-indicator">*</span>
									</label>
									<input type="hidden" id="agencyGroupContract.0.seqPremId" name="agencyGroupContract.0.seqPremId" value="${agencyGroupContract?.seqPremId}"/>
							...
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agencyGroupContract, field: 'overrideAmount', 'error')} ">
									<label for="overrideAmount"> 
										<g:message code="agencyGroupContract.overrideAmount.label" default="Override Amt :" /> 
									</label>
									<g:textField name="agencyGroupContract.0.overrideAmount" value="${agencyGroupContract?.overrideAmount}" class="amtNumeric" onkeypress="return isNumberKey(event)"
										maxlength="30" />
								</div>
							</td>
						</tr>
