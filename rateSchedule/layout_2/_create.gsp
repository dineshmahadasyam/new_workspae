...
<style>
	...
	<body>
		<a href="#create-agencyRateSchedule" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>		
		<div id="create-agencyRateSchedule" class="content scaffold-create" role="main">
			...
			<div class="right-corner" align="center">COMMR</div>
