									...
									<table border="0" id="group_member">
										<tr>
											<td class="innerbackground" colspan="4"
												style="color: #FFFFFF; text-align: center"><b>Find and Add Groups to Batch</b></td>
										</tr>
										<tr>
										...
										<g:each in="${groupMasterList}" status="i" var="groupMaster">
											...
											<tbody>
												<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
													...
													<td><div style="height: 40px; overflow: hidden;">
															<g:link class="searchButton" action="addGroupToBatch" id="${groupMaster.groupDBId}"
