...
$(document).ready(function(){
   ...
   function getAgentName() {
        ...
        if(agentTypeIdValue=="C" && agencyId !=""){
				  	var appName = "${appContext.metadata['app.name']}";
 				...
 				<fieldset class="memberMasterForm">
					<div id="fms_content_header">
					  <div class="fms_content_header_note">
					    &nbsp&nbsp<a href="${createLink(uri: '/agentMaster/list')}">Agent Maintenance</a>/ Create for Agent ID ${agentMasterInstance?.agentId}
					  </div>
					  <div class="fms_content_title">
					    <h1>&nbspCreate Agent</h1>
					  </div>
					</div>
				   <div class="right-corner" align="right">AGNTM&nbsp</div> 
