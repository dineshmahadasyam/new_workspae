...
<script type="text/javascript">
	...
	function createBankEft() {		
		window.location.assign('<g:createLinkTo dir="/agentMaster/createBankEft"/>?seqAgentId=${agentMasterInstance?.seqAgentId }&agentId=${agentMasterInstance?.agentId }&agentType=${agentMasterInstance?.agentType}');
	}
		...
		$('.InfoDeleteRow').click(function(e){ 
	 	...
	 	$('.BtnDeleteRow');
	      ...
	      $("#BtnDeleteRowYes").click(function(e){	  		         
	               ...
	               myFm.action = "/"+appName+"/agentMaster/deleteEFTdetails";     	
	               myFm.submit();
														...
														<div class="fms_form_column fms_long_labels">
															...
															<div class="fms_form_input">
																<g:if test="${accountInfoEdit.equals(true)}">
																	<g:secureTextField class="form-control" name="agentEFT.${i}.accountNumber" id="accountNumber" value="${agentEFT?.accountNumber}" 
																		title="The Bank Account Number" maxlength="25" tableName="AGENT_EFT" attributeName="accountNumber"
																		aria-labelledby="accountNumber_label" aria-describedby="accountNumber_error" aria-required="false">
																	</g:secureTextField>
																</g:if>	
																<g:else>						
																	<g:secureTextField class="form-control" name="agentEFT.${i}.accountNumber" id="accountNumber" value="${agentEFT?.accountNumber}"  
																		title="The Bank Account Number" disabled="${!elementsEnabled?"true":"false"}"
																		maxlength="25" tableName="AGENT_EFT" attributeName="accountNumber"
																		aria-labelledby="accountNumber_label" aria-describedby="accountNumber_error" aria-required="false">
																	</g:secureTextField>
																</g:else>
															...
															<label id="routingNumber_label" class="control-label fms_required" for="routingNumber">
								 							...
								 							<div class="fms_form_input">	
											                    <g:if test="${accountInfoEdit.equals(true)}">
																 	<g:secureTextField class="form-control" name="agentEFT.${i}.routingNumber" id="routingNumber" title="The ABA Routing Number of the Bank" 
																...
																<g:else>
																	<g:secureTextField class="form-control" name="agentEFT.${i}.routingNumber"	title="The ABA Routing Number of the Bank" disabled="${!elementsEnabled?"true":"false"}"
																		value="${agentEFT?.routingNumber}" id="routingNumber" maxlength="9" tableName="AGENT_EFT" attributeName="routingNumber"
																		aria-labelledby="routingNumber_label" aria-describedby="routingNumber_error" aria-required="false">
																	</g:secureTextField>
																</g:else>
															...
															<div class="fms_form_input">
																<g:secureTextField class="form-control" name="agentEFT.${i}.description" id="description" title="The Bank Account Description"	
