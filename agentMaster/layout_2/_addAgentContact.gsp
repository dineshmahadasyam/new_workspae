...
<body>
	...
	<div id="show-agent" class="content scaffold-show" role="main">
		<h1 style="color: #48802C">Add Contact to Agent/Broker : ${agentMasterInstance?.agentId }</h1>
		<div class="right-corner" align="center">AGNTC</div>
						...
						<tr>
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'contactName', 'error')} ">
									...
									<g:textField name="agentContact.0.contactName" value="${agentContact?.contactName}"  autofocus="autofocus"
						...
						<tr>
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'phoneNumber', 'error')} ">
									...
									<g:textField name="agentContact.0.phoneNumber" value="${agentContact?.phoneNumber}"  class="maskPhoneNumber"
							...
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'extension', 'error')} ">
									...
									<g:textField name="agentContact.0.extension" value="${agentContact?.extension}" class="maskExtension"  
						...
						<tr>
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'emailAddress', 'error')} ">
									...
									<g:textField name="agentContact.0.emailAddress" value="${agentContact?.emailAddress}"  
							...
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'faxNumber', 'error')} ">
									...
									<g:textField name="agentContact.0.faxNumber" value="${agentContact?.faxNumber}"  class="maskPhoneNumber"
						...
						<tr>
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'businessPhone', 'error')} ">
									...
									<g:textField name="agentContact.0.businessPhone" value="${agentContact?.businessPhone}" class="maskPhoneNumber" 
							...
							<td class="tdnoWrap">
								<div class="fieldcontain ${hasErrors(bean: agentContact, field: 'mobilePhone', 'error')} ">
									...
									<g:textField name="agentContact.0.mobilePhone" value="${agentContact?.mobilePhone}"  class="maskPhoneNumber" 
						...
						<tr>
							<td class="tdnoWrap">
								<div
									...
									<g:textField name="agentContact.0.userDefined1" maxlength="60"  value="${agentContact?.userDefined1}" />
								</div>
							</td>
							<td class="tdnoWrap">
								<div
									...
									<g:textField name="agentContact.0.userDefined2" maxlength="60"  value="${agentContact?.userDefined2}" />
								</div>
							</td>
						</tr>
						<tr>
							<td class="tdnoWrap">
								<div
									...
									<g:datePicker name="agentContact.0.userDate1" precision="day" noSelection="['':'']"
							...
							<td class="tdnoWrap">
								<div
									...
									<g:datePicker name="agentContact.0.userDate2" precision="day" noSelection="['':'']"
