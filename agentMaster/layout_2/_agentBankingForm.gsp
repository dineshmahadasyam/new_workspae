...
<div id="${agentMasterInstance?.seqAgentId}">
	...
	Agent/Broker Banking Records for Agent Id (${agentMasterInstance?.agentId}) 
	<br/>
	<br/>
						...
						<td class="tdnoWrap" style="white-space: nowrap">
								<div class="fieldcontain ${hasErrors(bean: agentEFT, field: 'termReason', 'error')} ">
									...
									<img width="25" height="25" style="float:none;vertical-align:bottom" class="magnifying"
										...
										onclick="lookup('agentEFT.${i}.termReason', 'com.perotsystems.diamond.dao.cdo.ReasonCodeMaster','reasonCode','reasonCodeTypeHidden','reasonCodeType')">
								</div>
							</td>		
