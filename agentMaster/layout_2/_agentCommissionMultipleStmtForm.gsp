		...
		<g:if test="${(agentMasterInstance?.agentCommissions)}">
			<g:each in="${yearList}" var="i">
				<g:set var="statementAlreadyDisplayed" value="${false}"/>
						<g:each in="${agentMasterInstance?.agentCommissions}" var="agentCommissionHeading">
								<g:set var="strYear" value="${formatDate(format:'yyyy',date:agentCommissionHeading?.creationDate)}" />
								<g:if test="${i.equals(strYear)}">
									<g:each in="${monthList}" var="j">
										<g:set var="strMonth" value="${formatDate(format:'MM',date:agentCommissionHeading?.creationDate)}" />
										<g:if test="${j.equals(strMonth)}">
											<g:if test="${statementAlreadyDisplayed.equals(false)}">
												...
												<table id="commissionStatement" style="width:100%; font-family:Calibri,sans-serif;">
													...
													<g:each in="${agentMasterInstance?.agentCommissions}" var="agentCommission">
														<g:set var="strYearForMontlyStatement" value="${formatDate(format:'yyyy', date:agentCommission?.creationDate)}" />
														<g:set var="strMonthForMontlyStatement" value="${formatDate(format:'MM', date:agentCommission?.creationDate)}" />
															...
															<g:if test="${j.equals(strMonthForMontlyStatement)}">
																<tr>
																	...
																	<g:if test = "${agentCommission?.groupCount}">
																		<g:set var="totalSubs" value="${agentCommission?.groupCount + totalSubs}" ></g:set>
																	</g:if>
																	<g:if test = "${agentCommission?.baseAmount}">
																		<g:set var="totalPremComm" value="${agentCommission?.baseAmount + totalPremComm}"></g:set>
																	</g:if>
												...
												<br/><br/>
												<table id="horizontalRule" style="width:100%;">
													<tr><td><hr/></td></tr>
												</table>
											</g:if>
